...
//mobile2
//mobile3 
//name="user_guid" type="hidden" value="{0C33DB5F-5B80-4D88-B4F7-1781981A6718}" />
///name="keyword" type="hidden"  value="Gazella" />
//name="shortcode" type="hidden" value="55678" />    
...
$curl_connection = 
 curl_init('http://yourwebsite.com/post.php');
